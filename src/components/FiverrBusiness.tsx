...
const FiverrBusiness = (props: Props) => {
  return (
    <div className="business">
      <div className="business-content">
        <div className="business-left">
          ...
          <h2>
            A solution built for <i className="font-playfair">business</i>
          </h2>
          <p>
          ...
          <p>
            <i className="fa-regular fa-circle-check"></i> Talent matching
          </p>
          <p>
            <i className="fa-regular fa-circle-check"></i> Dedicated account
            management
          </p>
          <p>
            <i className="fa-regular fa-circle-check"></i> Team collaboration
            tools
          </p>
          <p>
            <i className="fa-regular fa-circle-check"></i> Business payment
            solutions
          </p>
          <button className="btn-search-carousel rounded-lg">
            {" "}
