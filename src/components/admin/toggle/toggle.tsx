  ...
  return (
    <div>
      <input
        ...
        appearance-none 
        rounded-[0.4375rem] 
        bg-color-gray-light-2 before:pointer-events-none 
        before:absolute before:h-3.5 before:w-3.5 
        before:rounded-full before:bg-color-gray-light-2
        before:content-[''] 
        after:absolute after:z-[2] after:-mt-[0.1875rem] 
        after:h-5 after:w-5 after:rounded-full after:border-none after:bg-color-gray-light-2
        after:shadow-[0_0px_3px_0_rgb(0_0_0_/_7%),_0_2px_2px_0_rgb(0_0_0_/_4%)] 
        after:transition-[background-color_0.2s,transform_0.2s] after:content-[''] checked:bg-color-gray-light-2
        checked:after:absolute checked:after:z-[2] checked:after:-mt-[3px] checked:after:ml-[1.0625rem] 
        checked:after:h-5 checked:after:w-5 checked:after:rounded-full checked:after:border-none checked:after:bg-color-gray-light-2
        ...
        checked:focus:border-primary checked:focus:bg-color-gray-light-2 checked:focus:before:ml-[1.0625rem] checked:focus:before:scale-100 checked:focus:before:shadow-[3px_-1px_0px_13px_#3b71ca]
         checked:focus:before:transition-[box-shadow_0.2s,transform_0.2s] 
         dark:bg-color-gray-light-2 dark:after:bg-color-gray-light-2 dark:checked:bg-color-gray-light-2
         dark:checked:after:bg-color-gray-light-2 dark:focus:before:shadow-[3px_-1px_0px_13px_rgba(255,255,255,0.4)] 
